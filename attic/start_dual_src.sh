...
if lsusb | grep -qi "045e:02d9" ; then
	...
	# SUR40 connected
	#gst-launch-1.0 -e v4l2src device=/dev/v4l-touch0 ! "video/x-raw,format=GRAY8,width=960,height=540" ! videorate ! "video/x-raw,framerate=15/1" ! $SURFPIPE
	./sur40 $SURFCAM "$SURFPIPE"
else
